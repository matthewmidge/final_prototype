...
<div class="container-fluid">
        <div class="row">
            <br>
        <div class="col-md-3">
             <form class="navbar-form" method="post" action="searchhardtail.php">
                        <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search Hardtail" name="searchhardtail">
...
if(isset($_POST['submit'])){
			...
			$searchhardtail = $mysqli->real_escape_string($_POST['searchhardtail']); 
			//query database
			$resultset = $mysqli->query("SELECT * FROM ctp_products WHERE make OR model LIKE '%$searchhardtail%' AND category ='Hardtail'");
...
<div class="row"> 
    <br>
        ...
        <div class="col-md-9"> 
            <br>
            <a href="hardtail.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Reset</a>
