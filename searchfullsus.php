...
<div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3">
             ...
             <form class="navbar-form" method="post" action="searchfullsus.php">
                        <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search Full Suspension" name="searchfullsus">
...
if(isset($_POST['submit'])){
			...
			$searchfullsus = $mysqli->real_escape_string($_POST['searchfullsus']); 
			//query database
			$resultset = $mysqli->query("SELECT * FROM ctp_products WHERE make OR model LIKE '%$searchfullsus%' AND category ='Full Suspension'");
...
<div class="row"> 
    <br>
        ...
        <div class="col-md-9"> 
            <br>
            <a href="fullsuspension.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Reset</a>
