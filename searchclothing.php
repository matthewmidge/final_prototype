...
if(isset($_POST['submit'])){
			...
			$searchclothing = $mysqli->real_escape_string($_POST['searchclothing']); 
			//query database
			$resultset = $mysqli->query("SELECT * FROM ctp_products WHERE category ='Clothing' AND make LIKE '%$searchclothing%' OR model LIKE '%$searchclothing%'");
    ...
    <div class="row"> 
        ...
        <div class="col-md-9"> 
             <a href="clothing.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Reset</a>
