...
<div class="container-fluid">
    <div class="row">
        <br>
            <div class="col-md-3">
                <br>
             <form class="navbar-form" method="post" action="searchclearance.php">
                        <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search Clearance Bikes" name="searchclearance">
...
if(isset($_POST['submit'])){
			...
			//serach into secure variable 
			$searchclearance = $mysqli->real_escape_string($_POST['searchclearance']); 
			//query database
			$resultset = $mysqli->query("SELECT * FROM ctp_products WHERE price < 1000 AND make OR model LIKE '%$searchclearance%' AND category ='Hardtail' OR 'Full Suspension'");

			if ($resultset->num_rows > 0) {
				while ($rows = $resultset->fetch_assoc()) {
          $code = $rows['code'];
					echo "<div class='col-md-4'>" . $rows['make'] . "<br>" . $rows['model'] . "<br>" . "£" . $rows['price'] . "<br>" . "<a href='product.php?id=" . $code . "'>" . "<br>" . "<img src='img/products/JPEG/" . $rows['img'] . "'>" . "</a>" . "<br>" .  "</div>";
				}
			}else{
				echo "No Products Matching that word"; 
			}
	}
	?>
</div>
    ...
    <br>
        ...
        <div class="col-md-9"> 
             <a href="clearancebikes.php" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Reset</a>
